...
<html lang="en">
  ...
  <path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L1.707 7.5H10.5a.5.5 0 0 1 0 1H1.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3z"/>
        ...
        <section class="banner-part">
            ...
            <div class="container">
                <h3><a href="<?php echo BASE_URL . '/admin/posts/index.php'; ?>"><i class="fa fa-arrow-left" style="margin-right: 15px;" aria-hidden="true"></i></a>
 Edit Item</h3><br>
...
<div class="container">
  ...
  <div class="form-group"><br>
    ...
    <input type="text" class="form-control" name="title" value="<?php echo $title ?>" id="inputAddress" >
  </div>
    <div class="form-group">
    <label for="inputAddress">Link</label>
    <input type="text" class="form-control" name="link" value="<?php echo $link ?>" id="inputAddress" >
  </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-2">
      <label for="inputCity">Colour</label>
      <input type="color" class="form-control" name="color" value="<?php echo $color ?>" id="inputCity">
    </div>
  <div class="form-group">
    <label for="inputAddress2">By</label>
    <input type="text" class="form-control" name="body" value="<?php echo $body ?>" id="inputAddress2" >
  </div>
  <div class="form-group">
    ...
    <div class="form-group col-md-12">
      ...
      <select id="inputState"  name="topic_id" class="form-control">
    ...
    <?php if (empty($published)): ?>
      <input class="form-check-input" name="published" type="checkbox" id="gridCheck" checked>
      <label class="form-check-label" for="gridCheck" >
        Publish
      </label>
      <?php else: ?>
        <input class="form-check-input" name="published" type="checkbox" id="gridCheck">
      <label class="form-check-label" for="gridCheck" >
        Publish
      </label>
      <?php endif; ?>
