  ...
  <path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L1.707 7.5H10.5a.5.5 0 0 1 0 1H1.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3z"/>
        ...
        <section class="banner-part">
            ...
            <h3>Manage Posts</h3><br>
                ...
                <a href="create.php" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> 
 Add New Item</a><br><br>
  ...
  <?php foreach ($posts as $key => $post): ?>
    ...
    <tr>
      ...
      <?php if ($post['published']): ?>
                     ...
                     <td><a href="edit.php?published=0&p_id=<?php echo $post['id'] ?>" class="btn btn-success"><i class="fa fa-check" aria-hidden="true"></i>
 Active</a></td>
                                    <?php else: ?>
                                        <td><a href="edit.php?published=1&p_id=<?php echo $post['id'] ?>" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i>
 Inactive</a></td>
    ...
    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
      <a class="dropdown-item" href="edit.php?id=<?php echo $post['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
  <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
</svg>
 edit</a>
      <a class="dropdown-item" href="edit.php?delete_id=<?php echo $post['id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i>
 delete</a>
    </div>
  </div></td>
        </tr>
