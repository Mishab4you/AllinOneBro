...
<html lang="en">
  ...
  <path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L1.707 7.5H10.5a.5.5 0 0 1 0 1H1.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3z"/>
        ...
        <section class="banner-part">
            ...
            <div class="container">
            <h3>Welcome to Aiob Admin Panel</h3><br>
                        ...
                        <div class="feature-card">
                            ...
                            <div class="feature-content">
                                <h6 class="feature-name">
                                    <a href="product-video.html">Total Posts</a>
                                </h6>
...
echo '<h5 style="color: green;"> '.$row.'</h5>';
?></a></span>
                                </h6>
                               
                                <a href="posts/index.php" class="product-add" title="Add to Cart">
                                <i class="fa fa-plus" aria-hidden="true"></i>
                    ...
                    <div class="col">
                        <div class="feature-card">
                            ...
                            <div class="feature-content">
                                <h6 class="feature-name">
                                    <a href="product-video.html">Total Categories</a>
                                </h6>
...
?></a></span>
                                ...
                                <a href="topics/index.php" class="product-add" title="Add to Cart">
                                <i class="fa fa-plus" aria-hidden="true"></i>
                                    <span>Create New</span>
                                 </a>
                            </div>
                    ...
                    <div class="col">
                        <div class="feature-card">
                            ...
                            <div class="feature-content">
                                <h6 class="feature-name">
                                    <a href="product-video.html">Total Users</a>
                                </h6>
...
?></a></span>
                                ...
                                <a href="users/index.php" class="product-add" title="Add to Cart">
                                <i class="fa fa-plus" aria-hidden="true"></i>
                                    <span>Create New</span>
                                 </a>
